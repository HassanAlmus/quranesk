    ...
    <>
      ...
      {loading ? (
        ...
        <body className={styles.body}>
          <div className={styles.d1}>
            <div className={styles.d2}>
              <div className={styles.d3}>
                <div className={styles.d4} style={{ opacity: 1 }}>
                  <Image
                    src="/quran.png"
                    height={150}
                    width={250}
                ...
                <div className={styles.d5} style={{ opacity: 1 }}>
          ...
          <div className={styles.d7}>
            <div className={styles.d8}>
              ...
              <div className={styles.d9}>
                <div style={{ marginBottom: ".25rem" }} className={styles.d10}>
                  <h3>Surah</h3>
                  <Select
                    classNamePrefix="d100"
                    options={surahs.map((s: any, i: number) => {
                      return {
                        value: i + 1,
                        label: `${i + 1}. ${s.title}`,
                      };
                ...
                <div style={{ marginBottom: ".25rem" }} className={styles.d10}>
                  {ss && (
                    <>
                      <h3>Verse</h3>
                      <Select
                        classNamePrefix="d101"
                        options={Array.from(
                          Array(surahs[ss.value - 1].count).keys()
                        ).map((n) => {
                          return {
                            value: n + 1,
                            label: n + 1,
              ...
              <Link
                passHref={true}
                href={ss ? `/${ss.value}/${sv ? sv.value : "1"}` : ``}
              >
                <div
                  className={ss ? styles.d17 : styles.d18}
                  /* onClick={
                                    () => setLoading(true)
                            } */
                >
          ...
          <div className="announcement">
            <div className={styles.d32}>
              <h2
                onClick={() =>
                  alert(
                    "An immense amount of work was put towards perfecting this website, hence I would genuinely appreciate sharing it with anyone who would find it useful. Let's all help maximaize its benefits!"
                  )
                }
              >
            ...
            {surahs
              .filter(
                (s: any, i: number, arr: any) =>
                  i >= 0 && i <= (sm ? arr.length - 1 : 35)
              )
              .map((s: any, i: number) => (
                <div className={styles.d15} key={i}>
                  <Link passHref={true} href={`/${i + 1}/`}>
                    <div
                      className={styles.d16}
                      /* onClick={
                                        () => setLoading(true)
                                } */
                    >
                      <h1 style={{ fontFamily: "cinzel-bold" }}>{i + 1}</h1>
                    </div>
                  </Link>
                  <Link passHref={true} href={`/${i + 1}/`}>
                    <div
                      className={styles.d19}
                      /* onClick={
                                        () => setLoading(true)
                                } */
                    >
                          ...
                          <div className={styles.d14}>
                            <h2>
                              ...
                              {s.title
                                ...
                                .substring(
                                  0,
                                  s.title.split(" (")[1].length - 1
                                )}{" "}
                            </h2>
                            <h3 style={{ fontFamily: "cinzel-regular" }}>
                              {s.title.split(" (")[0]}
                            </h3>
                          </div>
                          <h1 className="uthmani">{s.titleAr}</h1>
                        </div>
                      </div>
                      ...
                      <div className={styles.d24}>
                        {s.juz.length === 1 ? (
                          <div className={styles.d23}>
                            <h2>{`Juz ${+(s.juz[0]?.index as string)}`}</h2>
                          </div>
                        ) : (
                          s.juz.map((j: any, i: number) => (
                            <div className={styles.d23} key={i}>
                              <h2>
                                {" "}
          ...
          <div className={styles.d30} onClick={() => setSm(!sm)}>
            <div className={styles.d31}>
              <h2>{sm ? "Show Less" : "Show More"}</h2>
            </div>
          </div>
          <div className={styles.d26}>
            <div className={styles.d27}>
              <div className={styles.d29}>
                <Image
                  src="/book-pile.png"
                  height={400}
                  width={300}
              ...
              <div className={styles.d28}>
                <a
                  className="a"
                  href="https://al-islam.org"
                  target="_blank"
                  rel="noreferrer"
                >
                  <h1>al-islam.org</h1>
            ...
            <div className={styles.d27}>
              ...
              <div className={styles.d28}>
                ...
                <h3>
                  Sunan {"&"}
                  Hadeeths of the Prophet and the Imams
                </h3>
              </div>
            </div>
          </div>
          ...
          <footer>
            <div className={styles.d25}>
              ...
              <p className="latin">
                <br></br>© 2023
                <a className="a" href="https://quranesk.com">
                  quranesk.com
                </a>
                . All Rights Reserved.
              </p>
