        ...
        <div className={
            ...
            <div className={
                ...
                !props.v && (
                    <h3 id={
                        styles.d105
                    }>In order to view more than one translation/tafseer simultaneously, navigate to specific verse.</h3>
                )
            }
                {
                !props.v && (
                        ...
                        <select onChange={
                            ...
                            props.surahAudioMap.map((reciter) => {
                                return (
                                    <option key={reciter}
                                        selected={
                                            reciter === props.user.surahAudio ? true : false
                                        }
                                        value={
                                            reciter.split(' ').join('')
                                    }>
                    ...
                    (props.tafseerMap).map((tafseer : Tafseer, key : number) => {
                        return (
                            <label key={key}
                                ...
                                <h4 className={
                                    tafseer.key === 'namoonaur' ? 'urdu' : (tafseer.key === 'khorramdelfa' ? 'farsi' : '')
                                }>
                                    {
                                    tafseer.name
                                }</h4>
                            ...
                            <div>
                                <div className={
                                    ...
                                    <h3 style={
                                        ...
                                        className={
                                            t.name === "Urdu" || t.name === "Farsi" ? t.name === "Urdu" ? "urdu" : "farsi" : ""
                                    }>
                                        {
                                        t.name2
                                    } </h3>
